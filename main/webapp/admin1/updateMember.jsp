...
<%
	...
	if(updateId == null || updateId.trim().equals("")){
		response.sendRedirect("memberList.jsp?msg=noUID");
		return;
	}
%>
<html>
...
<div class="container py-4">
   <jsp:include page="/menu.jsp" />
 	...
 	<div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-5">
        ...
        <p class="col-md-8 fs-4 text-danger">회원수정오류! 다시확인해주세요.</p>      
      	...
      	%>
      	<p class="col-md-8 fs-4">관리자 권한으로 회원 수정</p>
      	<%}%>
      </div>
    </div>
	...
	<div class="container">
		<form name="updateMember"action="processUpdateMember.jsp" method="post" >
				<div class="mb-3 row">
